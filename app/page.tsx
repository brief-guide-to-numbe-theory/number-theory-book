          ...
          <div className="acknowledgements-container" id="acknowledgements" data-reveal>
            ...
            <div className="acknowledgements-grid">
              ...
              <div className="acknowledgements-body">
                ...
                <p>
                  We are deeply thankful to our friend <strong>Mandar Kasulkar</strong> for writing certain parts of the book. We would also like to thank our friends <strong>Ronit Sharma</strong>, <strong>Bairav Murugan</strong>, <strong>Paras Kumar</strong>, <strong>Tanishka Gham</strong>, <strong>Lavish Khariwal</strong>, and <strong>Nishant Sahoo</strong> for their generous assistance in reviewing the manuscript, proofchecking, identifying mathematical and grammatical errors, and offering numerous helpful comments.
                </p>
                <p>
                  Last, but certainly not least, we would like to thank <strong>Abhay Mahajan Sir</strong>, who has mentored both of us throughout our Olympiad journey and has also played the crucial role of helping us get in touch with publishers. Special thanks to <strong>Roumak Das</strong> for helping us with the creation of this website.
                </p>
              </div>
            </div>
          </div>
