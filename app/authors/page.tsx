            ...
            <article className="author-card second" data-reveal>
              ...
              <div className="author-copy">
                ...
                <div className="author-bio">
                  ...
                  <p>
                    In lower grades, I also tried out other sports like swimming and chess. I could not continue swimming beyond grade 5 due to the lockdown, but I took classes for chess and represented my school in a few tournaments. Some of my other interests include reading — my favourite series is for sure <em>Percy Jackson and The Heroes of Olympus</em> — and playing the <strong>piano</strong> (I took classes, though I haven&apos;t taken the Trinity grade exams). During the lockdown, I also created 3 YouTube channels: one about the <strong>Rubik&apos;s Cube</strong>, one about <strong>Lego animations</strong>, and one dedicated to the <strong>piano</strong>.
                  </p>
                </div>
