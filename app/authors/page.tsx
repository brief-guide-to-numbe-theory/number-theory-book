          ...
          <div className="author-grid">
            ...
            <article className="author-card second d1" data-reveal>
              ...
              <div className="author-copy">
                ...
                <div className="author-bio">
                  <p>
                    I am Riddhiman Seal, a <strong>Grade 12 student</strong> and math enthusiast based in Mumbai. My journey into mathematics began in elementary school, but my passion for competitive problem-solving truly ignited in Grade 8 when my cousin introduced me to Olympiads. Tackling IOQM-level problems for the first time was a steep challenge, but it opened up a refreshing, creative side of mathematics that I quickly grew to love. Within Olympiad math, I focus heavily on <strong>geometry</strong> and <strong>number theory</strong>.
                  </p>
                  <p>
                    Over the years, I have actively participated in the Indian Olympiad cycle (<strong>IOQM</strong>, <strong>RMO</strong>, <strong>INMO</strong>) alongside individual contests like the <strong>AMC 10/12</strong> and <strong>AIME</strong>. Some key highlights of my contest journey include placing <strong>1st in the subjective round at the MTRP camp at ISI Kolkata</strong> and earning a <strong>3rd Diploma in the Sharygin Geometry Olympiad</strong>.
                  </p>
                  <p>
                    Together with my co-author Aritra, I have also competed in major team events — placing <strong>2nd in the Power Round at the Berkeley Math Tournament</strong> and <strong>1st overall in the Oxford Mathematics Team Competition</strong>. Outside of competing, I am an active staff member at the <a href="https://www.youtube.com/@OMath" target="_blank" rel="noopener noreferrer">Online Math Club (OMC)</a>, where I deliver lectures, curate problem sets, draft mock papers, and assist with general club administration.
                  </p>
                  <p>
                    The inspiration for this book came from a gap I noticed while studying Olympiad number theory: while standard classic texts exist, many modern, recurring ideas are scattered across short handouts without a centralized place to practice. When Aritra reached out to collaborate on a small handout, our draft quickly grew from 2 pages to over 100. Realizing that shortening the material would do a disservice to the subject, we made the bold decision to write a comprehensive book. Despite the challenge of balancing schoolwork with late-night writing sprints, this project grew into the complete resource we wished we had when we began our own Olympiad journeys.
                  </p>
                  <p>
                    Beyond mathematics, I have a strong background in martial arts and competitive athletics. I am a <strong>2nd-degree black belt in Taekwondo</strong> with over a decade of dedicated training under my belt, and I have also competed in football at the district level. In my free time, I enjoy following competitive sports, solving complex puzzles, and collaborating with students across the math community.
                  </p>
                </div>
